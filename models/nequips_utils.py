...
class MaterialsProjectDataset(AtomicDataset):
    """
    ...
    def download(self,
        ...
        mp.load(self.raw_file_name,down,downsave,format,self.raw_dir)
    ...
    def process(self,
        ...
        data = mp.load(self.raw_file_name,down,downsave,format,self.raw_dir)
