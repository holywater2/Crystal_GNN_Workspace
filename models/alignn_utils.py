...
def train_dgl(
    ...
    if config.log_tensorboard:
        ...
        print("{\"hparam/test_loss\": test_loss} type is",type({"hparam/test_loss": test_loss}))
        # tb_logger.writer.add_hparams(new_config, {"hparam/test_loss": test_loss})
        tb_logger.writer.add_scalar("test_loss",test_loss)
        tb_logger.close()
